...
main_folder_name = "2-2-direct-MA";
...
R_real = [1.0000    1.7000];
S_real = [-1.0000    0.8500];
...
skip_instances = max(len_desA, len_desB) + d-1;
...
for i = skip_instances:num_samples
    ...
    phi_filtered = [uf(i-d:-1:i-d-len_R+1), yf(i-d:-1:i-d-len_S+1)].';
    ym(i) = 0;
    error = y(i) - ym(i);
