...
main_folder_name = "1-5-3-indirect-minVar-NMP";
...
deg_desA = len_desA - 1;
deg_desB = len_desB;
A_estimated = [1,-0.5,0.2]; % initial conditions
B_estimated = [0.5, -1];
...
R_real = [1.0000    0.7829];
S_real = [-0.3879    0.1845];
...
for i = skip_instances:num_samples
    ...
    D_dio = conv(D_dio, modify_polynomial(B_estimated)); % **************** modified B
